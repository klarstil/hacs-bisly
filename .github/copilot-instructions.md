...
- `entity/` — Base entity class (`BislyEntity`)
...
- Entity MRO: `(PlatformEntity, BislyEntity)` — order matters
...
- Debug level: `custom_components.hacs_bisly: debug` in `config/configuration.yaml`
