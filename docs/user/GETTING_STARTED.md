# Getting Started with Bisly Home Assistant Websockets Integration

This guide will help you install and set up the Bisly Home Assistant Websockets Integration custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/klarstil/hacs-bisly`
6. Set category to "Integration"
7. Click "Add"
8. Find "Bisly Home Assistant Websockets Integration" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/klarstil/hacs-bisly/releases)
2. Extract the `hacs_bisly` folder from the archive
3. Copy it to `custom_components/hacs_bisly/` in your Home Assistant configuration directory
...
4. Select entities from "Bisly Home Assistant Websockets Integration"
...
- Report issues at [GitHub Issues](https://github.com/klarstil/hacs-bisly/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/klarstil/hacs-bisly/discussions)
