"""Device info utilities for hacs_bisly."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Bisly Home Assistant Websockets Integration",
        manufacturer=manufacturer or "Bisly Home Assistant Websockets Integration",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('hacs_bisly', 'entry_id_value')}
    """
