"""
Entity package for hacs_bisly.

Architecture:
    All platform entities inherit from (PlatformEntity, BislyEntity).
...
See entity/base.py for the BislyEntity base class.
"""

from .base import BislyEntity
