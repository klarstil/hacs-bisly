"""
Core DataUpdateCoordinator implementation for hacs_bisly.
...
class BislyDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    async def _async_update_data(self) -> Any:
        ...
        except BislyApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="hacs_bisly",
                translation_key="authentication_failed",
            ) from exception
        except BislyApiClientError as exception:
